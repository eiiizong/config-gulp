...
const copyfont = () => src('./src/fonts/**/*').pipe(dest('./dist/fonts/'))

const copy = parallel(copyhtml, copycss, copyfont, copylib, copyUtil)
// 检测文件
watch(['./src/*.html'], series(copyhtml, reload))
watch(['./src/styles/css/**/*'], series(delCss, copycss, scss, reload))
watch(['./src/lib/**/*'], series(delLib, copylib, reload))
watch(['./src/styles/scss/**/*'], series(delCss, copycss, scss, reload))
